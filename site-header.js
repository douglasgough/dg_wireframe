(() => {
  ...
  const isHome = trimmedPath === "" || trimmedPath === "/" || trimmedPath.endsWith("/index.html");
  ...
  const navItems = [
    ...
    { label: "Solutions", href: "/solutions.html", match: "/solutions.html" },
    { label: "How I Work", href: "/how-i-work.html", match: "/how-i-work.html" },
